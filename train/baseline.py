...
collator, model, train_multi_metrics, eval_multi_metrics,log_history = createAndTrainModel(dataset, args)
...
# model.load_state_dict(torch.load(os.path.join("..", "checkpoint", "bert_vit", "checkpoint-1000", "pytorch_model.bin")))
# model.to(device) 
